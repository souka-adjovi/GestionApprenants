...
<script src="{{asset('asset/jquery.nicescroll.js')}}"></script>
 <!-- charts scripts -->
 {{-- <script src="assets/jquery-knob/js/jquery.knob.js"></script> --}}
 <script src="{{asset('asset/assets/jquery-knob/js/jquery.knob.js')}}"></script>
 {{-- <script src="js/jquery.sparkline.js" type="text/javascript"></script> --}}
 <script src="{{asset('asset/js/jquery.sparkline.js')}}"></script>
...
<script src="{{asset('asset/js/jquery-jvectormap-world-mill-en.js')}}">
//    <script src="js/xcharts.min.js"></script>
<script src="{{asset('asset/js/xcharts.min.js')}}"></script>
   {{-- <script src="js/jquery.autosize.min.js"></script> --}}
<script src="{{asset('asset/js/jquery.autosize.min.js')}}">
//    <script src="js/jquery.placeholder.min.js"></script>
<script src="{{asset('asset/js/jquery.placeholder.min.js')}}"></script>
   {{-- <script src="js/gdp-data.js"></script> --}}
<script src="{{asset('asset/js/gdp-data.j')}}"></script>
